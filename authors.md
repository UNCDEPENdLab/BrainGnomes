...
- **Michael Hallquist**. Author, maintainer.

## Citation

Source:
[`DESCRIPTION`](https://github.com/UNCDEPENdLab/BrainGnomes/blob/0.8-1/DESCRIPTION)

Hallquist M (2026). *BrainGnomes: An R package for preprocessing and
analyzing fMRI data*. R package version 0.8-1,
