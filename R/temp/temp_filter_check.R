...
pre_spectra <- lapply(selected_positions, function(pos) power_multitaper(get_pre_ts(pos), dt = dt))
post_spectra <- lapply(selected_positions, function(pos) power_multitaper(get_post_ts(pos), dt = dt))
