...
#'
#' @keywords internal
derive_voxel_psc_scale <- function(img, reference_location, qa_mask, include_frames = NULL, target = 100.0, baseline_trim = 0.10, baseline_floor_fraction = 0.20, min_valid_frames = 20L, affine_tolerance = 1e-5, outfile = "") {
    .Call(`_BrainGnomes_derive_voxel_psc_scale`, img, reference_location, qa_mask, include_frames, target, baseline_trim, baseline_floor_fraction, min_valid_frames, affine_tolerance, outfile)
}
