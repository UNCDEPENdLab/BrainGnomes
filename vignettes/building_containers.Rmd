...
Used in postprocessing. NeuroDesk has a number of pre-built containers that work well, whereas
building FSL from a container file (e.g., https://www.repronim.org/neurodocker/user_guide/examples.html)
was throwing tricky errors on the UNC HPC.
